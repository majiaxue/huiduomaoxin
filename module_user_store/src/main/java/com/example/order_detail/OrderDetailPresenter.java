...
public class OrderDetailPresenter extends BasePresenter<OrderDetailView> {
    ...
    public void loadOrder(String masterNo) {
        Observable<ResponseBody> observable = RetrofitUtil.getInstance().getApi(CommonResource.BASEURL_4001).getHeadWithout(CommonResource.ORDER_DETAIL + "/" + masterNo, SPUtil.getToken());
