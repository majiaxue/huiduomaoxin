...
public class UserLeftRvAdapter extends MyRecyclerAdapter<ClassifyBean> {
    public UserLeftRvAdapter(Context context, List<ClassifyBean> mList, int mLayoutId) {
        super(context, mList, mLayoutId);
    }

    @Override
    public void convert(RecyclerViewHolder holder, ClassifyBean data, int position) {
