...
public class ConfirmOrderPresenter extends BasePresenter<ConfirmOrderView> {
    ...
    public void jumpToPayment() {
        ...
        Observable<ResponseBody> observable = RetrofitUtil.getInstance().getApi5(mContext).postHeadWithBody(CommonResource.CART_SUBMIT_ORDER, requestBody, SPUtil.getToken());
