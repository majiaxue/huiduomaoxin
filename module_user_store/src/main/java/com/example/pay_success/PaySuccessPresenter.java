...
public class PaySuccessPresenter extends BasePresenter<PaySuccessView> {
    ...
    public void loadData(String masterNo) {
        Observable<ResponseBody> observable = RetrofitUtil.getInstance().getApi(CommonResource.BASEURL_4001).getHeadWithout(CommonResource.PAYSUCCESS + "/" + masterNo, SPUtil.getToken());
