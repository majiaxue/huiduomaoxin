...
public class FlashSaleGoodsBean {
     ...
     * original_price : 0.0
     * self_buy : 1.0
     * xs_end_time : 2019-09-26 11:00:00
     * new_status : 1
     ...
     * verify_status : 1
     * id : 16
     * xs_start_time : 2019-09-26
     * stock : 0
     * seller_id : 1
     * share_buy : 1.0
     * created_time : 2019-09-26 09:54:16
     * promotion_type : 0
     * preview_status : 0
     * weight : 0.0
     * detail_mobile_html :
    ...
    private int id;
    private String xs_start_time;
    private int stock;
    private int seller_id;
    private double share_buy;
    ...
    public void setSelf_buy(double self_buy) {
        this.self_buy = self_buy;
    }

    public String getXs_end_time() {
        return xs_end_time;
    }

    public void setXs_end_time(String xs_end_time) {
        this.xs_end_time = xs_end_time;
    }
    ...
    public String getXs_start_time() {
        return xs_start_time;
    }

    public void setXs_start_time(String xs_start_time) {
        this.xs_start_time = xs_start_time;
    }
    ...
    public double getShare_buy() {
        return share_buy;
    }

    public void setShare_buy(double share_buy) {
    ...
    public String toString() {
        return "FlashSaleGoodsBean{" +
                "original_price=" + original_price +
                ", self_buy=" + self_buy +
                ", xs_end_time='" + xs_end_time + '\'' +
                ", new_status=" + new_status +
                ", feight_template_id=" + feight_template_id +
                ", pic='" + pic + '\'' +
                ...
                ", weight=" + weight +
                ", detail_mobile_html='" + detail_mobile_html + '\'' +
                ...
                ", low_stock=" + low_stock +
                ", use_point_limit=" + use_point_limit +
                ", description='" + description + '\'' +
                ", buy_num=" + buy_num +
                ", recommand_status=" + recommand_status +
