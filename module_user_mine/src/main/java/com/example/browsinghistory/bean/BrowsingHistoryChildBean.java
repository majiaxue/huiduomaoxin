 ...
 * Describe:
 */
public class BrowsingHistoryChildBean {
    private int image;
    private String name;
    ...
    public BrowsingHistoryChildBean(int image, String name, String price, String payment_amount, String good_reputation, String shop, boolean isCheck) {
        this.image = image;
        this.name = name;
        this.price = price;
