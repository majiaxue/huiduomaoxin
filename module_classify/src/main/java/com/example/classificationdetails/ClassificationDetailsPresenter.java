...
public class ClassificationDetailsPresenter extends BasePresenter<ClassificationDetailsView> {
    ...
    public void setClassifyRec(RecyclerView classificationRec, ImageView classificationSwitchover){
        ...
        classifyRecList.add(new RecBean(R.drawable.reco2, "有机护肤化妆品...", "领券减50元", "26.50", "123", "已抢64120件"));
        classifyRecList.add(new RecBean(R.drawable.reco3, "美容美妆教学...", "领券减50元", "42.80", "123", "已抢64120件"));
        classifyRecList.add(new RecBean(R.drawable.reco4, "美容美妆教学...", "领券减50元", "42.80", "123", "已抢64120件"));
        RecAdapter recAdapter = new RecAdapter(mContext, classifyRecList, R.layout.item_base_rec);
        classificationRec.setAdapter(recAdapter);
    ...
    public void setClassifyGridRec(RecyclerView classificationRec, ImageView classificationSwitchover){
        ...
        classifyGridRecList.add(new RecBean(R.drawable.reco2, "有机护肤化妆品...", "领券减50元", "26.50", "123", ""));
        classifyGridRecList.add(new RecBean(R.drawable.reco3, "美容美妆教学...", "领券减50元", "42.80", "123", ""));
        classifyGridRecList.add(new RecBean(R.drawable.reco4, "美容美妆教学...", "领券减50元", "42.80", "123", ""));
